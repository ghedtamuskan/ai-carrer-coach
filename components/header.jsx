  ...
  return (
    <header className="fixed top-0 w-full border-b bg-background/90 backdrop-blur supports-[backdrop-filter]:bg-background/60 z-50">
      <nav className="w-full mx-auto px-4 h-16 py-2 flex items-center justify-between">
        ...
        ">
                <DropdownMenuItem>
                  <Link href={"/resume"} className="flex items-center gap-2" onClick={() => setIsOpen(false)}>
                ...
                <DropdownMenuItem>
                  <Link href={"/ai-cover-letter"} className="flex items-center gap-2" onClick={() => setIsOpen(false)}>
                ...
                <DropdownMenuItem>
                  <Link href={"/interview"} className="flex items-center gap-2" onClick={() => setIsOpen(false)}>
